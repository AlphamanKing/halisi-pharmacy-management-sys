...
<body>
    <div class="container my-5">
        ...
        <a class="btn btn-primary" href="/PHARMACY/prescriptions_management/create.php" role="button">New Record</a>
        <br>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <td>
                    <a class='btn btn-primary btn-sm' href='/PHARMACY/prescriptions_management/edit.php?prescription_id=$row[prescription_id]'>Edit</a>

                    <a class='btn btn-danger btn-sm' href='/PHARMACY/prescriptions_management/delete.php?prescription_id=$row[prescription_id]'>Delete</a>
                    </td>
                </tr>
                    ";
                }
